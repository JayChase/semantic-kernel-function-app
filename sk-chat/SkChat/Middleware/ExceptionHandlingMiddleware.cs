    ...
    public async Task Invoke(FunctionContext context, FunctionExecutionDelegate next)
    {
        ...
        catch (Exception ex)
        {
            ...
            if (httpReqData != null)
            {
                ...
                {
                    // Create an instance of HttpResponseData with the status code from HttpResponseException.
                    newHttpResponse = httpReqData.CreateResponse(httpResponseException.Status);
                    await newHttpResponse.WriteAsJsonAsync(new { httpResponseException.Message });
                }
                else
                {
                    ...
                    await newHttpResponse.WriteAsJsonAsync(new { Message = "Internal server error" });
                }
